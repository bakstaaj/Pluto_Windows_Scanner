...
# Install/update Windows Pluto SDR Scanner GUI v2.0 Phase 2 Live Spectrum into
# the separate GUI folder.
# Default target:
#   ~/sdrdev/pluto_windows_scanner
#
# Run from MSYS2 UCRT64 after extracting this package to:
#   C:\Users\jim\Downloads\PlutoWindowsScannerGuiV2_Phase2_LiveSpectrum
#
# Example:
#   /c/Users/jim/Downloads/PlutoWindowsScannerGuiV2_Phase2_LiveSpectrum/tools/install_windows_scanner_gui_v2_phase2_live_spectrum.sh
...
Installed Windows Pluto SDR Scanner GUI v2.0 Phase 2 Live Spectrum into:
  $TARGET
...
Phase 2 adds live spectrum/waterfall controls backed by pluto_spectrum_stream.exe.
